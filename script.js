...
if (searchText.includes("beach")) {
    resultContainer.innerHTML = `
        ...
        <div class="card">
            <img src="https://images.unsplash.com/photo-1473116763249-2faaef81ccda"
                 alt="Tropical Beach">
            <div class="card-content">
    ...
    resultContainer.innerHTML = `
        <div class="card">
            <img src="https://images.unsplash.com/photo-1521292270410-a8c4d716d518"
                 alt="Beautiful Country">
            <div class="card-content">
        ...
        <div class="card">
            <img src="https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e"
    ...
    resultContainer.innerHTML = `
        <p>
            ...
            Try searching for Beach, Temple, or Country.
        </p>
    `;
}
```
